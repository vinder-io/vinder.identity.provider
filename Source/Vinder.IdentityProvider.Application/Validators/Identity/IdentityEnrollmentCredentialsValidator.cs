...
public sealed class IdentityEnrollmentCredentialsValidator :
    AbstractValidator<IdentityEnrollmentCredentials>
{
    public IdentityEnrollmentCredentialsValidator()
    {
